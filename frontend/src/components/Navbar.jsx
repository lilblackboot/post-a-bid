    ...
    <div>
        <nav className='bg-[#262C35] flex justify-between align-middle items-center'>
            ...
            <div className='flex justify-between gap-2 bg-[#262C35]'>
                <button className='bg-[#FE8D32] text-white p-2 px-5 rounded-full m-3'>Login</button>
                <button className='bg-[#367BFE] text-white p-2 px-5 rounded-full m-3'>Signup</button>
            </div>
        </nav>
    </div>
  )
